...
test -s "${dist}/firm_replay.wasm"
test -s "${dist}/firm_replay.js"

rm -rf "${output_dir}"
mkdir -p "${output_dir}/assets"
cp "${dist}/firm_replay.js" "${dist}/firm_replay.wasm" "${output_dir}/"
cp "${repo_dir}/replay-viewer/index.html" \
  ...
  "${output_dir}/"
for asset in cog_manager.png cog_worker_red.png cog_worker_blue.png \
  cog_worker_green.png cog_worker_yellow.png \
...
echo "firm replay viewer bundle: ${output_dir}"
