...
# Substitute: firm, coworld-firm, 5.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-firm:ci)
#   SMOKE_SLUG                 game slug                        (firm)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/firm)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/firm-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-firm:ci}}"
slug="${SMOKE_SLUG:-firm}"
