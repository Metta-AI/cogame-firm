...
Slurm job 9092, then reloaded checkpoints for held-out seeds 101 and 102.
Both variants scored 1.032 and 0.969 on those seeds. These bounded runs
verify execution, not stronger league play.
