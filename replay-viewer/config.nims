...
switch(
  "passL",
  (&"""
  -o {distDir / "firm_replay.js"}
  -O2
  -s ALLOW_MEMORY_GROWTH
  -s ABORTING_MALLOC=1
  -s ENVIRONMENT=web
  -s MODULARIZE=1
  -s EXPORT_NAME=FirmReplayModule
  -s EXPORTED_RUNTIME_METHODS=HEAPU8
  -s EXPORTED_FUNCTIONS=_main,_malloc,_free,_fm_load_replay,_fm_payload_ptr,_fm_payload_len,_fm_error_ptr,_fm_error_len
  """).replace("\n", " ")
)
